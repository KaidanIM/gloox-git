...
namespace gloox
{
  ...
  class _connection_base2
  {
    ...
    virtual _connection_base2<arg1_type, arg2_type,
  ...
  class _connection0 : public _connection_base0<mt_policy>
  {
    ...
    {
      return new _connection0<dest_type, mt_policy>( reinterpret_cast<dest_type*>(pnewdest), m_pmemfun );
    }
    virtual void Emit()
    {
      (m_pobject->*m_pmemfun)();
  ...
  class _connection1 : public _connection_base1<arg1_type, mt_policy>
  {
    ...
    {
      return new _connection1<dest_type, arg1_type, mt_policy>( reinterpret_cast<dest_type*>(pnewdest),
                                                                m_pmemfun );
    }
  ...
  class _connection2 : public _connection_base2<arg1_type, arg2_type, mt_policy>
  {
    ...
    {
      return new _connection2<dest_type, arg1_type, arg2_type,
                              mt_policy>( reinterpret_cast<dest_type*>(pnewdest), m_pmemfun );
    }
                                                ...
                                                arg3_type, arg4_type, mt_policy>
  {
    ...
    virtual _connection_base4<arg1_type, arg2_type, arg3_type, arg4_type, mt_policy>* duplicate(
      has_slots<mt_policy>* pnewdest )
    {
      return new _connection4<dest_type, arg1_type, arg2_type, arg3_type, arg4_type, mt_policy>(
               reinterpret_cast<dest_type*>(pnewdest), m_pmemfun );
    }
    virtual void Emit( arg1_type a1, arg2_type a2, arg3_type a3,
                       arg4_type a4 )
    {
                                                ...
                                                arg3_type, arg4_type, arg5_type, mt_policy>
  {
    ...
    {
      return new _connection5<dest_type, arg1_type, arg2_type, arg3_type, arg4_type,
                              arg5_type, mt_policy>( reinterpret_cast<dest_type*>(pnewdest), m_pmemfun );
    }
                                                ...
                                                arg3_type, arg4_type, arg5_type, arg6_type, mt_policy>
  {
    ...
    {
      return new _connection6<dest_type, arg1_type, arg2_type, arg3_type, arg4_type,
                              arg5_type, arg6_type, mt_policy>( reinterpret_cast<dest_type*>(pnewdest),
                                                                m_pmemfun );
    }
    virtual void Emit( arg1_type a1, arg2_type a2, arg3_type a3, arg4_type a4,
  ...
  {
    public:
    typedef typename _signal_base2<arg1_type, arg2_type,
                                                               ...
                                                               arg2_type) )
    {
      ...
      _connection2<desttype, arg1_type, arg2_type, mt_policy>* conn = new
                                                                      _connection2<desttype, arg1_type,
                                                                                   arg2_type, mt_policy>(
        pclass, pmemfun );
      this->m_connected_slots.push_back( conn );
      pclass->signal_connect( this );
  ...
  template<class arg1_type, typename arg2_type, typename arg3_type, typename mt_policy =
  ...
  {
    public:
    typedef typename _signal_base4<arg1_type, arg2_type, arg3_type, arg4_type,
                                   mt_policy>::connections_list::const_iterator const_iterator;
    signal4()
    {
      ;
  ...
  {
    public:
    typedef typename _signal_base5<arg1_type, arg2_type, arg3_type, arg4_type, arg5_type,
                                   mt_policy>::connections_list::const_iterator const_iterator;
    signal5()
    {
      ;
