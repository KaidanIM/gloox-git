...
namespace gloox
{
  ...
  enum StanzaExtensionType
  {
    ...
    ExtVCardUpdate,                 /**< Extension in the vcard-temp:x:update namespace, advertising
    ...
    ExtDelay,                       /**< An extension containing notice of delayed delivery (XEP-0203
                                     * & XEP-0091). */
    ExtAMP,                         /**< An extension containing advanced message processing rules
                                     * (XEP-0079). */
    ...
    ExtPSEvent,                     /**< An extension for PubSub event notifications (XEP-0060) */
    ExtUser                         /**< User-supplied extensions must use IDs above this. Do not
