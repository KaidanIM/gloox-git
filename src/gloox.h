...
namespace gloox
{
  GLOOX_API extern const std::string XMLNS_CLIENT;              /**< Client namespace (RFC 3920)*/
  GLOOX_API extern const std::string XMLNS_COMPONENT_ACCEPT;    /**< Component Accept namespace (XEP-0114) */
  GLOOX_API extern const std::string XMLNS_COMPONENT_CONNECT;   /**< Component Connect namespace (XEP-0114) */

  GLOOX_API extern const std::string XMLNS_DISCO_INFO;          /**< Service Discovery Info namespace (XEP-0030) */
  GLOOX_API extern const std::string XMLNS_DISCO_ITEMS;         /**< Service Discovery Items namespace (XEP-0030) */
  GLOOX_API extern const std::string XMLNS_ADHOC_COMMANDS;      /**< Adhoc Commands namespace (XEP-0050) */
  GLOOX_API extern const std::string XMLNS_COMPRESSION;         /**< Stream Compression namespace (XEP-0138) */
  GLOOX_API extern const std::string XMLNS_OFFLINE;             /**< Flexible Offline Message Retrieval (XEP-0013) */
  GLOOX_API extern const std::string XMLNS_CHAT_STATES;         /**< Chat State Notifications namespace (XEP-0085) */
  GLOOX_API extern const std::string XMLNS_AMP;                 /**< Advanced Message Processing (XEP-0079) */
  GLOOX_API extern const std::string XMLNS_IBB;                 /**< In-Band Bytestreams namespace (XEP-0047) */
  GLOOX_API extern const std::string XMLNS_FEATURE_NEG;         /**< Feature Negotiation namespace (XEP-0020) */
  GLOOX_API extern const std::string XMLNS_CHATNEG;             /**< Chat Session Negotiation namespace (XEP-0155) */
  GLOOX_API extern const std::string XMLNS_XHTML_IM;            /**< XHTML-IM namespace (XEP-0071) */
  GLOOX_API extern const std::string XMLNS_DELAY;               /**< Delayed Delivery namespace (XEP-0203) */
  GLOOX_API extern const std::string XMLNS_ROSTER;              /**< Roster namespace (RFC 3921) */
  GLOOX_API extern const std::string XMLNS_VERSION;             /**< Software Version namespace (XEP-0092) */
  GLOOX_API extern const std::string XMLNS_REGISTER;            /**< In-Band Registration namespace (XEP-0077) */
  GLOOX_API extern const std::string XMLNS_PRIVACY;             /**< Privacy lists namespace (RFC 3921) */
  GLOOX_API extern const std::string XMLNS_AUTH;                /**< Non-SASL Authentication namespace (XEP-0078) */
  GLOOX_API extern const std::string XMLNS_PRIVATE_XML;         /**< Private XML Storage namespace (XEP-0049) */
  GLOOX_API extern const std::string XMLNS_LAST;                /**< Last Activity namespace (XEP-0012) */
  GLOOX_API extern const std::string XMLNS_SEARCH;              /**< Jabber Search namespace (XEP-0055) */
  GLOOX_API extern const std::string XMLNS_IQ_OOB;              /**< Out of Band Data (IQ) namespace (XEP-0066) */
  GLOOX_API extern const std::string XMLNS_X_DATA;              /**< Data Forms namespace (XEP-0004) */
  GLOOX_API extern const std::string XMLNS_X_EVENT;             /**< Message Events (XEP-0022) */
  GLOOX_API extern const std::string XMLNS_X_OOB;               /**< Out of Band Data (X) namespace (XEP-0066) */
  GLOOX_API extern const std::string XMLNS_X_DELAY;             /**< Delayed Delivery namespace (XEP-0091) */
  GLOOX_API extern const std::string XMLNS_X_GPGSIGNED;         /**< Current Jabber OpenPGP Usage (Sign.) (XEP-0027) */
  GLOOX_API extern const std::string XMLNS_X_GPGENCRYPTED;      /**< Current Jabber OpenPGP Usage (Enc.) (XEP-0027) */
  GLOOX_API extern const std::string XMLNS_VCARD_TEMP;          /**< vcard-temp namespace (XEP-0054) */
  GLOOX_API extern const std::string XMLNS_X_VCARD_UPDATE;      /**< vCard-Based Avatars namespace (XEP-0153) */
  GLOOX_API extern const std::string XMLNS_BOOKMARKS;           /**< Bookmark Storage namespace (XEP-0048) */
  GLOOX_API extern const std::string XMLNS_ANNOTATIONS;         /**< Annotations namespace (XEP-0145) */
  GLOOX_API extern const std::string XMLNS_ROSTER_DELIMITER;    /**< Nested Roster Groups namespace (XEP-0083) */

  GLOOX_API extern const std::string XMLNS_XMPP_PING;           /**< XMPP Ping namespace (XEP-0199) */

  GLOOX_API extern const std::string XMLNS_MUC;                 /**< Multi-User Chat namespace (XEP-0045) */
  GLOOX_API extern const std::string XMLNS_MUC_USER;            /**< Multi-User Chat namespace (user) (XEP-0045) */
  GLOOX_API extern const std::string XMLNS_MUC_ADMIN;           /**< Multi-User Chat namespace (admin) (XEP-0045) */
  GLOOX_API extern const std::string XMLNS_MUC_UNIQUE;          /**< Multi-User Chat namespace (unique) (XEP-0045) */
  GLOOX_API extern const std::string XMLNS_MUC_OWNER;           /**< Multi-User Chat namespace (owner) (XEP-0045) */
  GLOOX_API extern const std::string XMLNS_MUC_ROOMINFO;        /**< Multi-User Chat namespace (roominfo) (XEP-0045) */
  GLOOX_API extern const std::string XMLNS_MUC_ROOMS;           /**< Multi-User Chat namespace (rooms) (XEP-0045) */
  GLOOX_API extern const std::string XMLNS_MUC_REQUEST;         /**< Multi-User Chat namespace (request) (XEP-0045) */

  GLOOX_API extern const std::string XMLNS_XMPP_STREAM;         /**< XMPP stream namespace (RFC 3920) */
  GLOOX_API extern const std::string XMLNS_XMPP_STANZAS;        /**< XMPP stanzas namespace (RFC 3920) */
  GLOOX_API extern const std::string XMLNS_STREAM_TLS;          /**< TLS Stream Feature namespace (RFC 3920) */
  GLOOX_API extern const std::string XMLNS_STREAM_SASL;         /**< SASL Stream Feature namespace (RFC 3920) */
  GLOOX_API extern const std::string XMLNS_STREAM_BIND;         /**< Resource Bind Stream Feature (RFC 3921) */
  GLOOX_API extern const std::string XMLNS_STREAM_SESSION;      /**< Session Create Stream Feature (RFC 3921) */
  GLOOX_API extern const std::string XMLNS_STREAM_IQAUTH;       /**< Non-SASL Auth. Stream Feature (XEP-0078) */
  GLOOX_API extern const std::string XMLNS_STREAM_IQREGISTER;   /**< In-Band Registration namespace (XEP-0077) */
  GLOOX_API extern const std::string XMLNS_STREAM_COMPRESS;     /**< Stream Compression Feature namespace (XEP-0138) */

  GLOOX_API extern const std::string XMPP_STREAM_VERSION_MAJOR; /**< Supported stream version (major). */
  GLOOX_API extern const std::string XMPP_STREAM_VERSION_MINOR; /**< Supported stream version (minor). */
  GLOOX_API extern const std::string GLOOX_VERSION;             /**< gloox version */
