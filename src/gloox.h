 ...
 *
 * One of the most important tools of gloox are the event handlers. Currently, there exist 4 handlers for
 ...
 * @endcode
 *
 * Now, everytime a presence stanza (not subscription stanza) is received the @ref handlePresence() is called
 * with the current stanza as an argument. You can then use the extensive getters of the Stanza class to
 * extract stanza data.
 *
 ...
 * @endcode
 *
 * @note The ConnectionListener interface is a peculiarity. You MUST re-implement @ref
 * gloox::ConnectionListsner::onTLSConnect() if you want to be able to connect successfully to TLS/SSL
