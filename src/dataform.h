...
namespace gloox
{
   ...
   * @since 1.0
   */
  class GLOOX_API Form : public DataForm
  {
    public:
      /**
       *
   ...
   * @since 1.0
   */
  class GLOOX_API Submit : public DataForm
  {
    public:
      /**
       *
   ...
   * @since 1.0
   */
  class GLOOX_API Cancel : public DataForm
  {
    public:
      /**
       *
   ...
   * @since 1.0
   */
  class GLOOX_API Result : public DataForm
  {
    public:
