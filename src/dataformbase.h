...
namespace gloox
{
  ...
  namespace DataForm
  {
     ...
     * @since 0.7
     */
    class GLOOX_API FieldContainer
    {
      public:
        /**
        ...
        bool hasField( const std::string& field )
          { return FieldContainer::field( field ) != 0; }
         ...
         */
        Field* field( const std::string& field ) const;
         ...
         * @since 0.9
         */
        virtual void addField( Field* field ) { m_fields.push_back( field ); }
         ...
         * @since 0.9.4
         */
        Field* addField( Field::FieldType type, const std::string& name,
                         const std::string& value = "", const std::string& label = "" )
        {
          Field* field = new Field( name, value, label, type );
