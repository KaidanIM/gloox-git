...
\paragraph{}
The most important dependency is the Iksemel\footnote{Iksemel can be found on \href{http://iksemel.jabberstudio.org}{http://iksemel.jabberstudio.org}} library written by Gürer Özen. Iksemel contains XML parsers (DOM as well as SAX) and offers many XMPP related low-level functions. It was chosen as parsing library for this project due to its efficiency and simplicity of usage, the small size and its self-containment.
