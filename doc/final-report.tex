...
% for compatibility with the interim report, this is not glued together
\subsection{Initial Schedule}
\paragraph{}
This is the initial project schedule as given in the Interim Report.
\input{interim-planning}

\include{revised-planning}

\include{final-planning}
